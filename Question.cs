...
public void BTAnswer(){
        ...
        if (currentAnswer.text == controlQust.qustions[numberQuestion].elementQuestion.Ans[controlQust.qustions[numberQuestion].elementQuestion.AnswerCorrect]){
            ...
            if (numberQuestion >= gameRound){
                ...
                panelResult.transform.GetChild(0).GetComponent<Text>().text = "Congratulstions";

                panelResult.transform.GetChild(1).gameObject.SetActive(false);
...

{
                ...
                panelResult.transform.GetChild(0).GetComponent<Text>().text = "Incorrec! please try again";
